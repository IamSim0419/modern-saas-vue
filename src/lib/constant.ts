...
export const footerLinks = [
  {
    title: "About",
    links: ["About Us", "Blog", "Careers", "Jobs", "In Press"],
  },
  {
    title: "Support",
    links: ["Contact Us", "Help Center", "Safety", "Community"],
  },
  {
    title: "FAQ",
    links: ["Account", "Manage Booking", "Pricing", "Payment"],
  },
  {
    title: "Account",
    links: ["Login", "Register", "Settings", "Dashboard"],
  },
  {
    title: "Jobs",
    links: ["Login", "Register", "Settings", "Dashboard"],
